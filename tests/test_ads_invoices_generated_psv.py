...
# coding: utf-8
"""
Regression test for ADS Invoices Generated PSV generation.

The semantic binding starts with the ADS Invoices_Generated definition table
and adds semantic_path to define which Structured CSV value fills each PSV
column.
"""
...
TARGET_NAME = "Invoices_Generated"
...
def main() -> int:
    ...
    subprocess.run(
        [
            ...
            str(structured_csv),
            "-b",
            str(ROOT / "specs" / "bindings" / "semantic" / "ADS_Invoices_Generated_PSV_Binding.csv"),
            "--taxonomy-base",
            str(ROOT / "out" / "taxonomy"),
            "-o",
            str(psv_dir),
    ...
    assert row["Customer_Account_ID"] == "BUYER-ID"
