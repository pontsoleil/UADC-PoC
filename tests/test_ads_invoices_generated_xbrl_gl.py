...
# coding: utf-8
"""
Regression test for ADS Invoices Generated XBRL GL generation.

The Invoices Generated view represents sales-side invoice data, so the party
mapping includes the invoice Buyer as the Customer and does not emit a Seller
party reference.
"""
...
def main() -> int:
    ...
    assert text(root, f"{entry_detail}/gl-cor:identifierReference/gl-cor:identifierCode") == "BUYER-ID"
