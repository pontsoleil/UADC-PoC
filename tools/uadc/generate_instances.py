...
for basis in ['anonymous_v17']:
    ...
    args=['to-structured',f'instances/original/PCA/{basis}/PCA.csv','-o',folder+'/accounting_entries.csv',
          '-m','models/xbrl-gl-next/accounting-entries/hmd/XBRL_GL_Next_HMD_AccountingEntries_for_taxonomy.csv',
    ...
    p=subprocess.run([sys.executable,'tools/uadc/flat_csv.py',*args],cwd=R,capture_output=True,text=True)
