...
HMD = 'models/xbrl-gl-next/accounting-entries/hmd/XBRL_GL_Next_HMD_AccountingEntries_for_taxonomy.csv'
results = []
...
def execute(label, args):
    p = subprocess.run([sys.executable, 'tools/uadc/flat_csv.py', *args], cwd=ROOT, capture_output=True, text=True)
