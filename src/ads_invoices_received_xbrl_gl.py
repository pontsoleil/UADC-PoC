...
def load_bindings(binding_csv: Path, lhm_columns: dict[str, str]) -> list[dict[str, str]]:
    ...
    for row in read_csv(binding_csv):
        ...
        source_column = (row.get("source_column") or lhm_columns.get(semantic_path) or "").strip()
...
def main() -> int:
    ...
    for csv_file in csv_files:
        output_name = args.output_filename or f"{args.output_stem_prefix}{csv_file.stem}.xbrl.xml"
